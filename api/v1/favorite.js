...
exports.add = function (req, res) {
    var option = req.body.option || {}, type = option.type, uid = req.auth.uid, id = option.id;
...
exports.list = function (req, res) {
    var page = req.query.page > 1 ? req.query.page : 1, type = req.query.type, uid = req.auth.uid, now_time = +new Date, timestamp = (page > 1 && req.headers['intern_list_ts']) ? req.headers['intern_list_ts'] : now_time;
...
exports.empty = function (req, res) {
    var option = req.body.option || {}, type = [], uid = req.auth.uid;
    try {
