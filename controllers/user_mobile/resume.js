...
exports.privateResumePreview = function (req, res) { //用户自己简历预览
    res.render("resume/detail", {
        resume: req.insert_data.resumes[0] || {}
    });
};
exports.resumeAdd = function (req, res) {
    ...
    option.user_id = uid;
    option.rid = rid;
    option.create_time = option.update_time = option.refresh_tme = timestamp;
    if (!resumes.length) {
 ...
 */
exports.resumeUpdate = function (req, res) {
