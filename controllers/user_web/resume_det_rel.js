...
var resp_status_builder = require('../../common/response_status_builder');
...
exports.delivery = function (req, res) {
    ...
    async.parallel([
        ...
        function (callback) {
            ...
            proxy.det.findOneById(option.det_id, function (err, job) {
                callback(err, job);
            });
...
exports.listPage = function (req, res) {
    var uid = res.locals.uid, now_time = +new Date, page = req.query.page > 1 ? req.query.page : 1, timestamp = (page > 1 && req.headers['intern_list_ts']) ? req.headers['intern_list_ts'] : now_time;
    var channel_type = req.query.ct || 2;
    proxy.resume_det_rel.list(uid, page, channel_type,timestamp, function (err, data) {
        if (err) {
            logger.error(err);
            return res.render("private/mysearchdet", {
        ...
        res.render("private/mysearchdet", data);
    });
};
