...
require(['js/lib/IB_jquery', 'js/lib/IB_fastclick','js/common/IB_fn','js/page/quickRecruit/IB_common','js/common/IB_job_type'], function ($, FastClick, fn, quickRecruit,job_types) {
    $(function () {
        ...
        //职位搜索
        if (location.href.indexOf("/employer/talentPool/list") > -1) {
            ...
            var url = "/employer/talentPool/list?cid=" + cid +"&jt="+ jt + "&mp=" + mp + "&wk=" + wk + "&dt=" + dt + "&et=" + et + "&ava=" + ava + "&page=" + pages;
                                ...
                                var newResume = "<div class='talent-info talent-info-hr talent-info-" + id + "'>\
                                                ...
                                                <div class='info-content clearfix'>\
                                                    ...
                                                    <div class='info-r'>\
                                                        ...
                                                        <div class='btn-area'>\
                                                            <a href='/employer/talentPool/detail/" + uid + "' target='_blank' class='btn btn-more'>查看详情</a>\
