...
require(['js/lib/IB_jquery', 'js/lib/IB_fastclick', 'js/lib/jquery-ui/widgets/IB_autocomplete','js/common/IB_fn','js/common/IB_tucao','js/common/IB_job_type','js/common/IB_regex','js/plugin/jquery.SuperSlide'], function ($, FastClick, autocomplete, fn, ScrollViewer,job_types,regex,jQuery) {
    $(function(){
       ...
       /* var job_type = $("#main-nav-content");
        ...
        $(".index-search-box-sel").hover(function(){
        ...
        $(".intern-search-next").click(function () {
           var $this = $(this);
            if(parseInt($this.attr("data-type")) == 3) {
                $(".intern-search-prev").text("校招").attr("data-type","3");
                $this.text("职位").attr("data-type","1");
            } else {
                $(".intern-search-prev").text("职位").attr("data-type","1");
                $this.text("校招").attr("data-type","3");
            }
            $this.hide();
        });
       ...
       /* $(".index-search-box-sel").hover(function(e){
        ...
        $(".index-search-box-btn").click(function(){
            ...
            var url;
            if(parseInt($(".intern-search-prev").attr("data-type")) == 3) {
                if(k){
                    url = "/j/search?type=campus&k="+k;
                    location.href= url;
                }else{
                    location.href= "/j/search?type=campus";
                }
            } else {
                if(k){
                    url = "/j/search?k="+k;
        ...
        $("#searchInput").autocomplete({
            ...
            select:function(event, ui){
                var url;
                if(parseInt($(".intern-search-prev").attr("data-type")) == 3)
                    url = "/j/search?type=campus&k="+encodeURIComponent(ui.item.label);
                else
                    url = "/j/search?k="+encodeURIComponent(ui.item.label);
                location.href= url;
            }
        });
        ...
        jQuery(".fullSlide").slide({ mainCell:".bd ul", effect:"leftLoop", autoPlay:true,trigger:"click" });
