...
require(['js/lib/IB_jquery','js/lib/IB_fastclick','js/common/IB_fn','js/common/IB_regex'],function ($,FastClick,fn,regex) {
    $(function(){
        ...
        if(global.step == 1){
            ...
            function checkInput(ue){
                ...
                if($(".company-logo").data("yes") !="yes"){
                    $("#logo").nextAll(".input-tips").remove();
                    $("#logo").after("<span class='input-tips'><span class='icon-prompt'></span>请上传logo</span>");
                    $(document).scrollTop(0);
                    flag = false;
                    return flag;
                }
                $(".required").each(function(){
                    if($.trim($(this).val()) == "" || ($(this).attr("type")=="button") && !$(this).hasClass("selected")){
                        $(this).nextAll(".input-tips").remove();
                        $(this).after("<span class='input-tips'><span class='icon-prompt'></span>必填</span>");
