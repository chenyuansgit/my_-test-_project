...
;(function (factory) {
                                ...
                                <div class='main-selector clearfix'>\
                                    <div class='side-wrapper side-wrapper-l'>\
                                       <div class='main-type-list' id='main-type'>\
                                            <div class='iscroll'>\
                                               <ul>\
                                                   <li class='sub-type' data-id=''>不限</li>\
                                               </ul>\
                                            </div>\
                                        </div>\
                                    </div>\
    ...
    var JobTypeSelector = function($ele,callback){
        ...
        $(document).on("click",".selector-jt .sub-type",function(){
            $(".selector-jt .sub-type.on").removeClass("on");
            var $this = $(this);
            $this.addClass("on");
    ...
    if (!$.fn.hasOwnProperty('jobTypeSelector')) {
        $.fn.jobTypeSelector = function (callback) {
            var $this = this;
            JobTypeSelector($this,callback);
            return this;
        };
    }
});