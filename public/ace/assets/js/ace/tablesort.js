    ...
    Plugin.prototype = {
        ...
        search: function (table, tableSortContainer) {
            ...
            if (table.hasClass('table-sort-search')) {
                ...
                var search = $('<div class="table-sort-search-container"><input class="table-sort-search-input larger" type="text" placeholder="Search..."></div>');
                ...
                if (typeof search.css('height') === 'string') {
                    ...
                    searchEmpty.css('display', 'none'); //interbird add
                }
